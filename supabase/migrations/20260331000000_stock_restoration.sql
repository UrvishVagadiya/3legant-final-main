...
-- Function to restore product stock based on order items
...
-- Grant execution to service_role (used by webhook and API)
GRANT EXECUTE ON FUNCTION public.restore_product_stock(jsonb) TO "service_role", "authenticated", "anon";
