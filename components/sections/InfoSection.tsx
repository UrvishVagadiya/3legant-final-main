const InfoSection = () => {
  return (
    <div className="px-3 sm:px-5 md:px-8 lg:px-20 xl:px-40 flex flex-col min-[960px]:flex-row min-[960px]:items-center justify-between mt-10 sm:mt-12 md:mt-16 lg:mt-24 gap-5 md:gap-6 lg:gap-10 mb-8 md:mb-14 lg:mb-16">
